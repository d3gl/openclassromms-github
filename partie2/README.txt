# Exercice partie 2
## Consigne
L'objectif est de mettre en pratique les notions acquises dans les deux premières parties du cours sur Git et Github.

Il suffit de créer un repository Git simple contenant :
